...
Updates: 
1) Merge Code with skip-gram1.py
2) Make_windows function if condition installed such that very short sentences can be windowed properly
3) In the process of fixing + <EOL>
Note: Entire code works aparts from adding <EOL>
